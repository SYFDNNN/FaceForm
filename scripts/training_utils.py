...
class _GradCAM:
    ...
    def __init__(self, model: nn.Module):
        ...
        self._hooks.append(target.register_forward_hook(self._save_activations))
        self._hooks.append(target.register_full_backward_hook(self._save_gradients))
...
def generate_gradcam(
    ...
    plt.tight_layout()
    plt.savefig(output_path, bbox_inches="tight", facecolor="#0f1724", edgecolor="none")
    plt.close(fig)
